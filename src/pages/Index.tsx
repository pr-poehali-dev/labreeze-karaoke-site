...
const EVENTS = [
  ...
  },
  {
    ...
    description: "Мы соединили массовое караоке, лото и самую зажигательную дискотеку. Вас ждёт весёлый день, наполненный любимыми хитами для совместного пения и танцевальными моментами.",
    tag: "Music Bingo",
  },
];
