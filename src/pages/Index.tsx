...
const EVENTS = [
  ...
  {
    id: 4,
    title: "Музыкальное БИНГО в Анапе!",
    date: "12 сентября (суббота)",
    time: "Сбор гостей 18:30. Начало игры в 19:00",
    image: "https://cdn.poehali.dev/projects/3fa0fa67-7615-44dd-ac91-dea1559fd9c7/bucket/26382a72-a565-454b-a4ff-f021b601d5c3.png",
    description: "Мы соединили массовое караоке, лото и самую зажигательную дискотеку. Вас ждёт весёлый день, наполненный любимыми хитами для совместного пения и танцевальными моментами. Проходит на втором этаже, Ресто-бар «Эфир».",
    tag: "Music Bingo",
  },
];
    ...
    <section id="karaoke" style={{ backgroundColor: "var(--cream)" }} className="py-28 px-6">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        <div className="reveal order-2 lg:order-1">
          ...
          >
            <img
              src="https://cdn.poehali.dev/projects/3fa0fa67-7615-44dd-ac91-dea1559fd9c7/bucket/b681075b-8044-4f35-814f-245010736e33.png"
